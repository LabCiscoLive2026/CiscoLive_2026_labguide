...
<figure markdown>
  ![Main Dashboard - PDU Section](./assets/task2/1.png)
</figure>
</div>
...
<div class="dashboard-imgs" markdown>
<figure markdown>
  ![PDU Outlet View - Phase Load](./assets/task2/2.png)
</figure>
</div>
...
<div class="dashboard-imgs" markdown>
<figure markdown>
  ![PDU Outlet View - Phase Load](./assets/task2/3.png)
</figure>
</div>

When it is clicked, you will see the **Power Consumption** for “SEA01-103-AU-5-PDU-2” panel showing the **historical power usage** in kW for the **last seven days**.

<div class="dashboard-imgs" markdown>
<figure markdown>
  ![PDU Outlet View - Phase Load](./assets/task2/outlet_1.png)
</figure>
</div>
...
<div class="dashboard-imgs" markdown>
<figure markdown>
  ![PDU Outlet View - Phase Load](./assets/task2/outlet_2.png)
</figure>
</div>
...
<div class="dashboard-imgs" markdown>
<figure markdown>
  ![Outlet Trend](./assets/task2/outlet_3.png)
...
<div class="dashboard-imgs" markdown>
<figure markdown>
  ![Outlet Trend](./assets/task2/outlet_4.png)
  <!-- <figcaption>Outlet #17 — Historical trend (last 30 days)</figcaption> -->
</figure>
</div>
...
<div class="dashboard-imgs" markdown>
<figure markdown>
  ![Outlet Trend](./assets/task2/outlet_5.png)
  <!-- <figcaption>Outlet #17 — Historical trend (last 30 days)</figcaption> -->
</figure>
</div>

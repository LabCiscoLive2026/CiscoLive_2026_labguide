...
3. Ensure the time picker is set to **Last 24 hours**. (Add a screenshot of the search bar and time picker if your printed deck still calls that out—same path as in *SNALabv2.docx*.)

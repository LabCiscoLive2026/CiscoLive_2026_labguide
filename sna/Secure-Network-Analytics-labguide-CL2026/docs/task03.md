...
!!! important "Capture your client IPv4"
    After VPN connects, record **Client Address (IPv4)** from Secure Client’s **Status Overview**. Task 4 uses that value as a **Subject IP** filter so export rows match **your** session traffic.

    ...
    <div className="relative flex min-h-screen flex-col bg-white">
      <header className="absolute left-0 right-0 top-0 z-10 flex items-center justify-between px-6 py-4">
        <div className="flex justify-center items-end gap-2 text-white">
          <CiscoLogo />
          <span className="text-lg font-medium bg-red-0 leading-7 tracking-wide text-[#6cc04a]">
            SECURE
          </span>
        </div>
        <div className="flex items-center gap-6 text-sm text-[#3d4a5c]">
          <button
            type="button"
            className="flex items-center gap-1 hover:text-[#1c3e6a]"
          >
      ...
      <div className="flex min-h-0 w-full flex-1 flex-col md:flex-row md:items-stretch">
        ...
        <div className="flex w-full flex-1 flex-col justify-center px-8 py-12 md:w-[50%] md:flex-none md:px-8 lg:px-8 md:py-12">
          <div className='md:w-[80%]'>
            <h1 className="mb-10 text-5xl font-bold tracking-tight text-[#2b3848]">
            ...
            <form onSubmit={handleSubmit} className="max-w-md space-y-6">
              <div>
                ...
                <input
                  ...
                  className="rounded-sm md:w-[60%] text-sm border border-[#0b5fc0] px-1 py-1 text-[#2b3848] placeholder:text-[#9aa5b1] focus:border-[#005eb8] focus:outline-none focus:ring-1 focus:ring-[#005eb8]"
                />
              </div>
              <div>
                <label className="mb-1 block text-sm font-medium text-[#3d4a5c]">
                ...
                <div className="relative w-full md:w-[60%]">
                  <input
                    ...
                    className="w-full rounded-sm border border-[#0b5fc0] px-2 py-1.5 pr-14 text-sm text-[#2b3848] placeholder:text-[#9aa5b1] focus:border-[#005eb8] focus:outline-none focus:ring-1 focus:ring-[#005eb8]"
                  />
                  <button
                    type="button"
      ...
      <footer className="border-t border-[#e8ecef] px-6 py-2 text-center text-xs text-[#7a8794]">
        ...
        >
          ...
          >
            <div className="px-6 pt-6 pb-4">
              ...
              <div className="mt-4 space-y-3 text-sm leading-relaxed text-[#3d4a5c]">
            ...
            <div className="flex justify-end border-t border-[#e8ecef] bg-[#f5f5f5] px-4 py-3">
              <button
                type="button"
